...
urlpatterns = [
    ...
    path("groups/<int:pk>/messages/<int:mid>/pin/", groups.group_pin, name="group-pin"),
    path("groups/<int:pk>/bot/", groups.group_bot, name="group-bot"),
    path("groups/<int:pk>/bot/timers/", groups.group_bot_timer, name="group-bot-timers"),
    path("threads/<int:pk>/messages/<int:mid>/pin/", chatx.dm_pin, name="dm-pin"),
    path("voice/<int:pk>/", chatx.voice_dm, name="voice"),
    path("groups/voice/<int:pk>/", groups.group_voice, name="group-voice"),
